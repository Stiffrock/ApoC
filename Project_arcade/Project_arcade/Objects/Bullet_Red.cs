...
namespace Project_arcade
{
    class Bullet_Red : GameObject
    {
        ...
        public Bullet_Red(Vector2 position, int dir, PlayerIndex playerIndex)
        {
            this.texture = TextureManager.GetTexture("projectile_1");
            this.velocity = new Vector2(9, 9);
        ...
        {
            spriteBatch.Draw(texture, position, srcRec, Color.Red, rotation, origin, 1.0f, spriteEffect, 1.0f);
